...
export default function InvoicePreviewStandard({
  invoice,
}: InvoicePreviewProps) {
        ...
        <div className="flex-1">
          ...
          {invoice.companyLicense && (
            <p className="text-sm text-gray-600">
              Licence: {invoice.companyLicense}
            </p>
          )}
        </div>
      ...
      <div className="grid grid-cols-2 gap-8 mb-8">
        <div>
          ...
          {invoice.clientLocation && (
            <p className="text-sm text-gray-600">{invoice.clientLocation}</p>
          )}
          {invoice.clientPhone && (
          ...
          <div className="w-64">
            ...
            {invoice.transportFees > 0 && (
              <div className="flex justify-between py-2 border-b border-gray-200">
                ...
                <span className="font-semibold">
                  {formatCurrency(invoice.transportFees, invoice.currency)}
                </span>
              </div>
            )}
              ...
              <div className="flex justify-center py-2">
                <div className="flex justify-center py-2">
                  <img
                    src={signatureImage}
                    alt="Signature"
                    className="h-20 object-contain scale-150"
                  />
                </div>
              </div>
            ) : (
