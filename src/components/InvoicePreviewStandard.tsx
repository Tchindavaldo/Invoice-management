...
export default function InvoicePreviewStandard({ invoice }: InvoicePreviewProps) {
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-green-700 text-white">
              ...
              {invoice.invoiceType === 'dhl' && <th className="px-4 py-3 text-center font-semibold">Poids</th>}
          ...
          <tbody>
            {invoice.items.map((item, index) => (
              ...
              >
                ...
                {invoice.invoiceType === 'dhl' && <td className="px-4 py-3 text-center border-b border-gray-200">{item.weight}</td>}
