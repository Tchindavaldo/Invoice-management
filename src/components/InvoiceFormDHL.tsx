...
export default function InvoiceFormDHL({ initialData, onSubmit, onCancel, isEditing = false }: InvoiceFormProps) {
    ...
    Object.entries(errors).forEach(([key, message]) => {
      ...
      if (key.startsWith('item_')) {
        ...
        const fieldNameMap: { [key: string]: string } = {
          invoiceNumber: 'Numéro de bordereau',
          date: 'Date',
    ...
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6 pb-4 border-b border-gray-200">
        <h2 className="text-2xl font-bold text-gray-900">
          {isEditing ? 'Modifier le bordereau DHL' : 'Nouveau bordereau DHL'}
        </h2>
        <button
          type="button"
          onClick={onCancel}
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Informations de l'entreprise (Header)</h3>
        <p className="text-sm text-gray-600 mb-4">
          Ces informations apparaîtront dans l'en-tête.
        </p>
      ...
      <div className="mb-8 pb-6 border-b border-gray-200">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Articles / Lignes</h3>
            <p className="text-sm text-gray-600">Ajoutez les articles pour le bordereau DHL</p>
          </div>
          <button
            type="button"
            onClick={addItem}
      ...
      <div className="flex justify-end gap-3">
        ...
        >
          ...
          <span className="hidden sm:inline">{saving ? 'Enregistrement...' : (isEditing ? 'Mettre à jour' : 'Créer le bordereau')}</span>
